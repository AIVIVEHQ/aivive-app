# Privacy Policy for AIVIVE

## Introduction

Welcome to **AIVIVE — the first Recursive AI Protocol** — an AI image feed where a programmable share of platform revenue automatically deflates the underlying network. At AIVIVE, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using AIVIVE:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use AIVIVE, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access AIVIVE, such as device type, operating system, and browser type.
...
**Copyright Owner**: [aivive.ai](http://aivive.ai)
**Email**: [support@aivive.ai](mailto:support@aivive.ai)

By using AIVIVE, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
