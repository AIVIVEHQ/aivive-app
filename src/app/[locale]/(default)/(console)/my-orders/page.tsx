...
export default async function () {
  ...
  const columns: TableColumn[] = [
    ...
    { 
      name: "paid_email", 
      title: t("my_orders.table.email"),
      callback: (item: any) => item.paid_email || item.user_email || "-"
    },
    { 
      name: "product_name", 
      title: t("my_orders.table.product_name"),
      callback: (item: any) => item.product_name || item.product_id || "-"
    },
    {
      name: "amount",
    ...
    },
    {
      ...
      callback: (item: any) => {
        ...
        try {
          return moment(item.paid_at).format("YYYY-MM-DD HH:mm:ss");
        } catch (e) {
          return "-";
        }
      },
